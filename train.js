...
const CANVAS_SIZE = 1000 // Matches the input size of MobileNet.
...
;(async function main() {
  ...
  parser.addArgument("--logDir", {
    type: "string",
    help:
      "Optional tensorboard log directory, to which the loss " +
  ...
  */
  const { images, targets } = dataprep.generateDataset()
  //console.log(images.shape)
  //await dataprep.generateDataset();
